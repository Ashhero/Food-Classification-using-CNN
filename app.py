...
def predict():
    ...
    class_labels = ['Burger', 'Butter Naan', 'Chai', 'Chapathi', 'Chole Bhature', 'Dal Makhani', 
                    'Dhokla', 'Fried Rice', 'Idli', 'Jalebi','Khaathi Rolls','Kadai Paneers','Kulfi',
                    'Masala Dosa','Momos','Paani Puri','Pakode','Pav Baaji','Pizza','Samosa']
